...
export const BassScreen: React.FC = () => {
    ...
    const handleHarmonyChange = (type: 'root' | 'scale', value: string) => {
        if (type === 'root') harmony.setRoot(value)
        else harmony.setScale(value as any)
                ...
                <div className="bass-harmony-section">
                    <div className="harmony-controls">
                        ...
                        <select
                            id="bass-root-select"
                            value={harmony.root}
                            onChange={(e) => handleHarmonyChange('root', e.target.value)}
